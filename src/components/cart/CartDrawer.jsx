            ...
            {cart.length > 0 && (
              <div className="border-t border-gray-100 bg-white p-5 pb-safe">
                ...
                <button
                  ...
                  className="w-full py-4 bg-purple-primary text-white font-inter text-sm font-medium uppercase tracking-wider rounded-full hover:bg-emerald-900 transition-colors"
                >
                  Proceed to Checkout
                </button>
